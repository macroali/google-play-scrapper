...
class GooglePlayScraper
{
    ...
    public function findAppByPackage($packageName, $locale = BaseValue::DEFAULT_LOCALE)
    {
        ...
        return new SmarterObject\Application($this->dom, $packageName);
    }
...
$googlePlayScraper = new GooglePlayScraper;
$result = $googlePlayScraper->findAppByPackage('com.rebellionpay.rebellion');
echo "<pre>";
var_dump($result);
echo "</pre>";